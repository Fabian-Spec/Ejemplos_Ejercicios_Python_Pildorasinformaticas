...
def nota_quices(codigoestudiante, nota1, nota2, nota3, nota4, nota5):
    ...
    promedio = "%.2f" %((((nota1 + nota2 + nota3 + nota4 + nota5 - nota_bajita)/4)*0.05))
    return promedio

print(nota_quices("codigoesdutiante", nota1, nota2, nota3, nota4, nota5))
print("El promedio ajustado del estudiante " + codigoestudiante + " es: " + str((nota_quices("codigoesdutiante", nota1, nota2, nota3, nota4, nota5))))
print("El promedio ajustado del estudiante",codigoestudiante,"es:",str((nota_quices("codigoesdutiante", nota1, nota2, nota3, nota4, nota5))))
